...
from Pereval_virt.pereval.resources import STATUS, LEVEL
from Pereval_virt.pereval.models import Pereval, Coords, Users, Images
from pereval_virt.pereval.serializers import PerevalSerializer, PerevalDetailSerializer
